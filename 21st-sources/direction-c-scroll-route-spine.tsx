// Source: 21st.dev Inspiration — "Scroll Legend"
// Query: "vertical scroll progress sidebar"
// Date pulled: 2026-04-28
// Used in: Direction C (Now Boarding) — left-edge subway route spine with active station indicator
// Translation notes: Replaced the horizontal-tick legend with a vertical line + colored MTA route bullets.
//                    Active state pulses + scales; dormant states show small grey dot.
//                    Names hidden until hover; on tap (mobile) the panel pops open.
